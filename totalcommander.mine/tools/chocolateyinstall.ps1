...
$packageName = 'totalcommander.mine' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  # optional
  registryUninstallerKey = 'totalcommander.mine' #ensure this is the value in the registry
  checksum      = ''
